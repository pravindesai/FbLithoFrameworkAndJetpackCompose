        ...
        return
                Column.create(cc).child(
                        ...
                        Row.create(cc).child(
                                ...
                                Image.create(cc).drawableRes(R.drawable.ic_baseline_gps_fixed_24).scaleType(ImageView.ScaleType.CENTER).heightDip(24).widthDip(24).flex(0)
